...
public class GoodPalindromeIntegerCounter {
    public static void main(String[] args) {
        GoodPalindromeIntegerCounter solver = new GoodPalindromeIntegerCounter();
        System.out.println("n = 3, k = 5 → " + solver.countGoodIntegers(3, 5));   //  27
        System.out.println("n = 1, k = 4 → " + solver.countGoodIntegers(1, 4));   //  2
        System.out.println("n = 5, k = 6 → " + solver.countGoodIntegers(5, 6));   //  2468
        System.out.println("n = 5, k = 4 → " + solver.countGoodIntegers(5, 4));
    }
